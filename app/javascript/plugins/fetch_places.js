const fetchPlaces = () => {
  ...
  const fetch = () => {
    var title = document.getElementById('tip_title');
    fetch(`https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=${title.value}&inputtype=textquery&fields=photos,formatted_address,name,rating,opening_hours&key=AIzaSyB2mMPcIoj9QC7EHZRxTwHZDDRphAOLgM8`)
